...
import { Form, Input, Button, message, Divider, DatePicker } from "antd";
import { UserOutlined, MailOutlined, LockOutlined, FileTextOutlined, PictureOutlined } from "@ant-design/icons";
